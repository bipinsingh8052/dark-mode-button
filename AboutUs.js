...
export default function AboutUs() {
    ...
    const [nochange,changetext]=useState("Enable dark mode");
  ...
  return (
    ...
    <div classNameName="conatiner-fluid" style={dark}>
        <h1>About us</h1>
        <button className="btn btn-primary" onClick={changeState}>{nochange}</button>
